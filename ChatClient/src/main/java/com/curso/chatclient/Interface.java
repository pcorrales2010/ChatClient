...
public class Interface {
     ...
     */
    public void run(int isClient) throws ClientException, InterruptedException, IOException, NoSuchAlgorithmException {
     ...
     * @throws java.io.IOException
     */
    public boolean runAuthentication(int isClient) throws InterruptedException, IOException {
        String serverAnswer = "";
     ...
     * @throws com.curso.exceptions.ClientException
     */
    public boolean inputUsernamePassword(String mode, int isClient) throws InterruptedException, IOException, ClientException {
        String username;
        String password;
    ...
    public boolean sendCredentials(String username, String password, String mode) throws IOException, ClientException, InterruptedException {
